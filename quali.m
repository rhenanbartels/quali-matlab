...
function rescaleImage(hObject, eventdata)
   ...
   fig = figure('Position', [0, 0, 300, 300],...
    ...
    orientationGroup = uibuttongroup('Parent', fig,...
        'Units', 'Normalized',...
   ...
   uicontrol('Parent', fig,...
    ...
    function [slope, intercept] = getSlopeIntercept(handles)
        ...
        switch rescaleOption
            ...
            case 'custom'
                slope = str2double(handles.slopeEdit.String);
                intercept = str2double(handles.interceptEdit.String);
            case 'roi'
                %TBD
                % slope = handles.rescaleSettings.slope;
                %intercept = handles.rescaleSettings.intercept;
        end
    end
    ...
    function okRescaleSettings(hObject, eventdata)
        ...
        rescaleOption = getRescaleOption(handles.rescale_gui);
        [slope, intercept] = getSlopeIntercept(handles.rescale_gui);
        
        handles.rescaleSettings.option = rescaleOption;
