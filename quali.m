...
function rescaleImage(hObject, eventdata)
   ...
   uicontrol('Parent', fig,...
    ...
    function handles = removeRescalingFromImage(handles, rescaleOption,...
            slope, intercept)
        if ~strcmp(rescaleOption, 'none')
            handles.data.imageCoreInfo.matrix =...
                (handles.data.imageCoreInfo.matrix - intercept)./ slope;
        end
    end

    function handles = rescaleImage(handles)
       if ~strcmp(handles.rescaleSettings.rescaleOption, 'none')
           handles.data.imageCoreInfo.matrix =...
               handles.data.imageCoreInfo.matrix * handles.rescaleSettings.slope...
