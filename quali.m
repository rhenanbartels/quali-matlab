...
function showResults(results)
    ...
    function showCustomizableIndices()
       annotation(resultsFig,...
            'textbox',...
            'Units', 'Normalized',...
            'Position', [0.02, 0.12, 0.1, 0.03],...
            'String', 'Perc_{x}:',...
            'FontSize', 12,...
            'FontWeight', 'Bold',...
            'Color', 'w',...
