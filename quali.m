...
function updateWindowMin(hObject, eventdata)
    ...
    windowMin = get(handles.gui.windowMinSlider, 'Value');
    windowMax = get(handles.gui.windowMaxSlider, 'Value');
    
    % Update Window Width Text
    set(handles.gui.editWindowMin, 'String', num2str(round(windowMin)));    
end
...
function updateWindowMax(hObject, eventdata)
    ...
    % Update Window Width Text
    set(handles.gui.editWindowMax, 'String', num2str(round(windowMax)));    
end
